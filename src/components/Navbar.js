...
const Navbar = () => {
  ...
  return (
    ...
    dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8 bg-transparent
    "
    >
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden ">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://twitter.com/VivekAg39601097"
            target={"_blank"}
            className="w-6 mr-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://www.linkedin.com/in/vivek-aggarwal-b005b125a/"
            target={"_blank"}
            className="w-6 mx-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
